  ...
  if (!t) {
    return (
      <main className="min-h-screen pt-32 flex justify-center text-red-500 font-bold">
        Error: Could not find 'privacy' in the translations dictionary. Check index.js.
      </main>
    );
  }

  return (
    <main dir={dir} className="min-h-screen pt-32 pb-16 px-6 md:px-12 bg-white dark:bg-neutral-950">
