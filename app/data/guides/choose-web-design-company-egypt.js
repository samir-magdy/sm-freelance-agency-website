...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Mid-size projects, specialist skills</td>
...
<p>After years of watching businesses pick the wrong provider and then come back to rebuild what they paid for the first time, the pattern is brutally consistent. The right provider will have a portfolio of live sites, ask deep questions about your goals, be transparent about EGP pricing, and communicate clearly about who is doing the work. At SM Web Design Studio, these are the standards we hold ourselves to as a web design company. Before reaching out, you can browse our <a href="/en/#FAQs">web design FAQs</a> for answers to the most common questions before starting a project. If you want a direct conversation about your project, we are happy to help — <a href="/en/#contact">request a free web design consultation</a>.</p>`,
    ...
    ar: `
<p>شركة تصميم المواقع المناسبة في مصر عندها سابقة أعمال من مواقع حقيقية تقدر تدخل عليها دلوقتي، بتسأل عن أهدافك، شفافة في التسعير، وبتتواصل بوضوح في مرحلة الاتفاق. وقبل تقييم أي مقدم خدمة بعينه، لازم تقرر الأول هل تختار فريلانسر، استوديو، ولا شركة كبيرة بناءً على حجم شغلك، وبعدين خد بالك من العلامات التحذيرية اللي بتفرق بين الكيانات المحترفة فعلاً واللي هتضيع وقتك وفلوسك.</p>
...
<ul>
  ...
  <li><strong>مش مهتمين يعرفوا حاجة عن شغلك:</strong> لو الشركة إدتك سعر من غير ما تسألك عن أهدافك، جمهورك، ومنافسيك، يبقوا بيبيعوا لك "قالب" جاهز مش حل لمشكلتك.</li>
  <li><strong>أسعار مبالغ فيها (رخيصة أو غالية):</strong> السعر الرخيص زيادة معناه شغل قوالب وأساس تقني ضعيف. والأسعار الخرافية ممكن تكون استغلال، شفنا شركات في مصر بتطلب 50,000 جنيه في موقع ووردبريس بسيط، وده رقم غير منطقي. اقرأ دليلنا عن <a href='/ar/guides/website-cost-in-egypt'>تكلفة الموقع إلكتروني في مصر: تحليل حقيقي للأسعار</a>.</li>
</ul>

<h2>وجهة نظرنا: ازاي تختار شركة تصميم مواقع صح</h2>
<p>من سنين من مشاهدة شركات بتختار مقدم الخدمة الغلط وبعدين بيرجعوا علشان نعيد بناء اللي دفعوا تمنه أول مرة، النمط ثابت بقسوة. الشركة الصح هي اللي عندها سابقة أعمال حقيقية، بتسأل أسئلة ذكية عن أهدافك، شفافة في أسعارها بالجنيه، وواضحة في تواصلها. في <strong>SM Web Design Studio</strong>، دي المعايير اللي بنمشي عليها. قبل ما تكلمنا، تقدر تتفرج على <a href="/ar/#FAQs">أسئلة شائعة عن تصميم المواقع في مصر</a> علشان تلاقي إجابة لأكتر الأسئلة اللي بتسأل عنها الشركات المصرية قبل ما تبدأ مشروع. ولو محتاج استشارة حقيقية لمشروعك، يسعدنا ندردش معاك. <a href="/ar/#contact">تطلب استشارة مجانية لتصميم موقعك</a>.</p>`,
  },
  metaDescription: {
