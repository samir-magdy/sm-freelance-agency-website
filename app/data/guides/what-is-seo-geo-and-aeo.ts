...
<ul>
  ...
  <li><strong>هدفك:</strong> أن يتم اختيار موقعك كـ "الإجابة القاطعة والوحيدة" عندما يطرح المستخدم سؤالاً مباشراً، غالباً أثناء انشغاله أو استخدامه لجهاز ذكي.</li>
</ul>
