...
const termsOfService: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: {
        en: "Projects are billed in two installments:\n\n• 50% deposit is required before any work begins. This deposit is non-refundable and secures your project slot.\n\n• The remaining 50% is due upon final delivery, before the final website files or credentials are handed over.\n\nWork will not commence until the deposit is received and confirmed. The final deliverables will not be transferred until the remaining balance is paid in full.",
        ar: "تُسدَّد مبالغ المشاريع على دفعتين:\n\n• دفعة مقدمة بنسبة 50% مطلوبة قبل البدء في أي عمل، وهي غير قابلة للاسترداد وتضمن حجز موعد مشروعك.\n\n• الـ 50% المتبقية تُستحق عند التسليم النهائي، قبل تسليم ملفات الموقع النهائية أو بيانات الوصول.\n\nلن يبدأ العمل إلا بعد استلام الدفعة المقدمة وتأكيدها. ولن يتم تسليم المخرجات النهائية إلا بعد سداد الرصيد المتبقي بالكامل.",
      },
    },
    {
      title: {
