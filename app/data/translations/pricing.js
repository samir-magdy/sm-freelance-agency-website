const pricingSection = {
  ...
  tiers: [
    ...
    },
    {
      ...
      price: "9,900",
      tagline: {
        en: "Better Design. Wider Reach. More Content.",
        ar: "تصميم أفضل. وصول أوسع. محتوى أكثر.",
      },
      highlighted: true,
      features: [
  ...
  disclaimer: {
    en: "Pricing is subject to change based on your specific requirements.",
    ar: "الأسعار قابلة للتغيير بناءً على متطلباتك.",
  },
  whatsappMessage: {
