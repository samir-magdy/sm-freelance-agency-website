...
const privacyPolicy: LegalDocument = {
  ...
  subheading: {
    en: `Last Updated: August 20, 2026. Welcome to ${SITE_NAME}. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website and use our services.`,
    ar: `آخر تحديث: 20 أغسطس 2026. مرحبًا بك في ${SITE_NAME}. نحن ملتزمون بحماية معلوماتك الشخصية وحقك في الخصوصية. تشرح سياسة الخصوصية هذه كيف نقوم بجمع واستخدام وحماية معلوماتك عند زيارة موقعنا واستخدام خدماتنا.`,
  },
  sections: [
    {
      title: {
      ...
      content: {
        en: "We collect personal information that you voluntarily provide when you submit a contact or inquiry form. This includes your name, email address, phone number, preferred contact method, and any project details you choose to share.\n\nWe also collect the messages you send to our on-site AI chat assistant (\"Nollie\"). This may include any personal information you choose to share during the conversation.\n\nWe automatically collect your IP address when you submit a form or send a message to the chat assistant. This is used solely for rate-limiting purposes (to prevent automated abuse of our contact form and chat widget) and is not used for tracking, profiling, or marketing.",
        ar: "نحن نجمع المعلومات الشخصية التي تقدمها طواعية عند إرسال نموذج التواصل أو الاستفسار، وتشمل: اسمك، وعنوان بريدك الإلكتروني، ورقم هاتفك، وطريقة التواصل المفضلة لديك، وأي تفاصيل تتعلق بمشروعك.\n\nكما نجمع الرسائل التي ترسلها إلى مساعدنا الذكي على الموقع (\"نولي\")، وقد تتضمن أي معلومات شخصية تختار مشاركتها أثناء المحادثة.\n\nنجمع تلقائيًا عنوان IP الخاص بك عند إرسال النموذج أو إرسال رسالة إلى المساعد الذكي، وذلك حصريًا لأغراض تحديد معدل الإرسال ومنع الإساءة الآلية لنموذج التواصل ونافذة الدردشة لدينا، ولا يُستخدم لأغراض التتبع أو تحليل السلوك أو التسويق.",
      },
    },
    {
      title: {
    ...
    },
    {
      ...
      content: {
        en: "IP addresses collected for rate-limiting are automatically deleted from Upstash after 3 minutes (contact form) or 10 minutes (chat assistant). Form submission data (name, contact details, project message) is retained in our email system for as long as necessary to manage our client relationships and fulfil any ongoing service obligations, after which it is deleted. Chat conversations are not stored by us after your session ends; they are processed by Groq solely to generate a response, subject to Groq's own data retention policies.",
        ar: "يتم حذف عناوين IP المجمعة لأغراض تحديد معدل الإرسال تلقائيًا من Upstash بعد 3 دقائق (نموذج التواصل) أو 10 دقائق (مساعد الدردشة). يتم الاحتفاظ ببيانات نماذج التواصل (الاسم وبيانات التواصل ورسالة المشروع) في نظام البريد الإلكتروني لدينا طالما كان ذلك ضروريًا لإدارة علاقاتنا مع العملاء والوفاء بأي التزامات خدمية جارية، وبعد ذلك يتم حذفها. لا نقوم بتخزين محادثات الدردشة بعد انتهاء جلستك؛ إذ تتم معالجتها بواسطة Groq فقط لتوليد الرد، وفقًا لسياسات الاحتفاظ بالبيانات الخاصة بـ Groq.",
      },
    },
    {
      title: {
