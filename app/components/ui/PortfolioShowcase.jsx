      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div dir="ltr" className="flex items-center justify-center gap-6">
            ...
            <div
              ref={phoneRef}
              className="phone-outer w-[60%] h-[58svh] sm:w-65 sm:h-130 md:w-72.5 md:h-137.5 lg:w-[320px] lg:h-152.5 rounded-[48px] bg-[linear-gradient(145deg,#2a2a2e_0%,#1c1c1e_50%,#161618_100%)] p-1 relative shrink-0"
            >
              {/* Left volume buttons */}
