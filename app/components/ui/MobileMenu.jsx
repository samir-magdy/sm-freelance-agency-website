...
export default function MobileMenu({ lang, nav, a11y, langToggleLabel }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-black/40 transition-opacity duration-[250ms] ease-out ${isMenuOpen ? "opacity-100 backdrop-blur-3xl" : "opacity-0 backdrop-blur-none"}`}
      />
