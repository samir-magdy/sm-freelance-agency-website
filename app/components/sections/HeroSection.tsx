      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6 px-6 sm:px-0">
            <a
              href="#contact"
              className="text-center bg-gradient-to-b from-[#d4af37] to-[#8b7125c9] text-white/95 focus:ring-2 focus:ring-[#d4af37]/50 hover:shadow-2xl transition duration-300 font-semibold text-base md:text-3xl px-10 py-3 md:px-12 md:py-6 rounded-full"
            >
          ...
          <a
            ...
            className="whatsapp-float inline-flex items-center justify-center gap-2 md:p-5 bg-[#25d365] hover:bg-[#198942] text-[#FFFFFF] font-semibold text-base md:text-subheading rounded-full transition-colors duration-300"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
