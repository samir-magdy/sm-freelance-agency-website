  ...
  return (
    ...
    >
      ...
      <div className="safari-hero-padding relative z-10 w-full mx-auto flex flex-col items-center text-center px-8 sm:px-10 pt-36 pb-24 sm:pt-40 sm:pb-28">
        ...
        <h2
          id="hero-title"
          className="mt-4 rtl:mt-2.5 rtl:sm:mt-4 sm:mt-6 text-content-heading font-medium tracking-[-2px] leading-[1.12] text-[clamp(2.25rem,11.5vw,4.5rem)] rtl:text-[clamp(2.25rem,10vw,4rem)] rtl:leading-relaxed max-w-[16ch] sm:tracking-[-4px] sm:max-w-[14ch]"
