  ...
  return (
    <div>
      ...
      >
        ...
        <div
          id="hero-container"
          className="relative z-10 flex flex-col items-center w-full pb-12 md:p-0"
        >
          <h1 className="font-bold text-center text-content-heading px-10">
            <span className="hero-fade hero-fade-label block text-content-muted text-[0.7rem] md:text-[0.8rem] tracking-wider font-medium uppercase mb-3 md:mb-4">
              {t.hero.seoLabel[lang]}
            </span>
            <span
              id="hero-hook"
              className="block text-[clamp(2.5rem,14vw,6rem)] rtl:leading-normal rtl:md:mb-0 leading-tight mb-6 md:mb-10"
            >
          ...
          <p className="hero-fade hero-fade-nav text-content-body text-[clamp(1.125rem,2.5vw,1.5rem)] text-center mb-8 md:mb-10 px-8">
          ...
          <div className="flex flex-col items-center gap-3">
            <a
              href="#contact"
              className="cta-primary text-center bg-gradient-to-b from-gold to-gold-dark text-gray-900 font-semibold text-base md:text-lg px-12 md:px-16 py-4 md:py-5 rounded-xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-light"
            >
            ...
            <a
              href="#portfolio"
              className="hero-fade hero-fade-secondary-cta group inline-flex items-center gap-1.5 text-content-muted hover:text-content-body text-sm font-medium transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-light rounded-sm"
            >
