  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="hero-fade hero-fade-label font-normal md:font-medium text-center text-content-muted text-[clamp(0.8rem,2vw,1.25rem)] rtl:me-2 tracking-wide uppercase mb-6">
