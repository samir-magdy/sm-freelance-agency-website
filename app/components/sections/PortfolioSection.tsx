      ...
      >
        ...
        <div className="reveal-element flex flex-col items-center gap-2.5">
          ...
          <div dir="ltr" className="flex items-center justify-center gap-8">
            ...
            <div
              id="mobile-mockup"
              className="aspect-11/19.5 w-[240px] sm:w-[230px] md:w-[260px] lg:w-[300px] rounded-[46px] bg-[linear-gradient(145deg,#2a2a2e_0%,#1c1c1e_50%,#161618_100%)] p-1 relative shrink-0"
            >
